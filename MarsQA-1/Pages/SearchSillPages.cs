    ...
    class SearchSkills
    {
        ...
        public void Searchskills()
        {
            ...
            try
            {
                ...
                {
                    test.Log(AventStack.ExtentReports.Status.Pass, "Test Passed, SearchSkills Page Visible");
        ...
        public void RefineSearchVisible()
        {
            ...
            ExcelLibHelper.PopulateInCollection(ConstantHelpers.ExcelPath, "Profile");
            Thread.Sleep(4000);
            String ActualUser = Driver.driver.FindElement(By.LinkText("sampath3 kumar3")).Text;
            String ActualSkill = Driver.driver.FindElement(By.LinkText("Sampath Java")).Text;
            Thread.Sleep(3000);
